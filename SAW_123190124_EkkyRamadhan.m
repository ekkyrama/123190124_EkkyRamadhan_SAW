function varargout = SAW_123190124_EkkyRamadhan(varargin)
% SAW_123190124_EKKYRAMADHAN MATLAB code for SAW_123190124_EkkyRamadhan.fig
%      SAW_123190124_EKKYRAMADHAN, by itself, creates a new SAW_123190124_EKKYRAMADHAN or raises the existing
%      singleton*.
%
%      H = SAW_123190124_EKKYRAMADHAN returns the handle to a new SAW_123190124_EKKYRAMADHAN or the handle to
%      the existing singleton*.
%
%      SAW_123190124_EKKYRAMADHAN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SAW_123190124_EKKYRAMADHAN.M with the given input arguments.
%
%      SAW_123190124_EKKYRAMADHAN('Property','Value',...) creates a new SAW_123190124_EKKYRAMADHAN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SAW_123190124_EkkyRamadhan_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SAW_123190124_EkkyRamadhan_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SAW_123190124_EkkyRamadhan

% Last Modified by GUIDE v2.5 23-Jun-2021 21:50:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SAW_123190124_EkkyRamadhan_OpeningFcn, ...
                   'gui_OutputFcn',  @SAW_123190124_EkkyRamadhan_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SAW_123190124_EkkyRamadhan is made visible.
function SAW_123190124_EkkyRamadhan_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SAW_123190124_EkkyRamadhan (see VARARGIN)

% Choose default command line output for SAW_123190124_EkkyRamadhan
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes SAW_123190124_EkkyRamadhan wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SAW_123190124_EkkyRamadhan_OutputFcn(hObject, eventdata, handles) 
...
if V(1) == resultMax
    set(handles.Result, 'String', 'Ekky');
elseif V(2) == resultMax
    set(handles.Result, 'String', 'Rama');
elseif V(3) == resultMax
    set(handles.Result, 'String', 'Fahira');
elseif V(4) == resultMax
    set(handles.Result, 'String', 'Putri');
end;
